...
@interface WeiXiuAdd2016View ()<UICollectionViewDataSource, UICollectionViewDelegate,UITextFieldDelegate,HSDatePickerViewControllerDelegate,UIAlertViewDelegate,UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
{
    MatnRec *matnRec;
...
@implementation WeiXiuAdd2016View
...
//                                      self.img7_label.text = @"最小燃烧量";
                                      ...
                                      self.img4_button.tag = 5;
                                      self.img5_button.tag = 6;
                                      self.img6_button.tag = 7;
                                      self.img7_button.tag = 4;
...
//                                      self.img12_label.text = @"高发真空值";
                                      ...
                                      self.img9_button.tag = 10;
                                      self.img10_button.tag = 11;
                                      self.img11_button.tag = 12;
                                      self.img12_button.tag = 9;

                                      self.scrollView.contentSize = CGSizeMake(self.view.frame.size.width, self.img12_view.frame.origin.y + self.img12_view.frame.size.height + 554);
